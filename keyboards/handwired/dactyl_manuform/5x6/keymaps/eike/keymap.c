...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_QWERTY] = LAYOUT_5x6(
     ...
     KC_LCTL, KC_Z  , KC_X  , KC_C  , KC_V  , KC_B  ,                         KC_N  , KC_M  ,KC_COMM,KC_DOT ,KC_SLSH,KC_RCTL,
                      KC_LGUI,KC_LALT,                                                       KC_RALT, KC_RGUI,
                                       KC_SPC,KC_BSPC,                         LOWER,KC_ENT,
                                      SPECIAL,NAVLAY,                         KC_END,  KC_DEL,
                                      RAISE, RGBLAY,                        KC_LGUI, KC_LALT
  ),
  ...
  [_NAVLAY] = LAYOUT_5x6(
     ...
     _______,_______,KC_MS_L,KC_MS_D,KC_MS_R,KC_LPRN,                        KC_LEFT, KC_DOWN , KC_UP , KC_RGHT ,KC_MINS,KC_PIPE,
     _______,_______,_______,_______,_______,_______,                        KC_MPRV,KC_MPLY,KC_MNXT,_______ ,_______, KC_UNDS,
                      _______,KC_PSCR,																						 						_______, KC_P0,
