...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_LOWER] = LAYOUT_5x6(
     ...
     KC_TILD,KC_EXLM, RALT(KC_7) ,RALT(KC_0),KC_DLR ,KC_PERC,                         KC_P7 , KC_P8 , KC_P9 ,KC_NLCK,KC_ASTR,KC_PLUS,
     KC_CIRC,KC_AMPR,LSFT(KC_8),LSFT(KC_9),KC_NUHS,RALT(KC_Q),                         KC_P4 , KC_P5 , KC_P6 ,KC_TILD,KC_PSLS,KC_MINS,
